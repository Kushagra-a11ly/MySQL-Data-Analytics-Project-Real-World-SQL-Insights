...
This project focuses on extracting business insights from an HR Analytics dataset using Basic → Intermediate → Advanced SQL concepts.

The goal is to analyze employee behavior, attrition causes, satisfaction levels, career growth, compensation structure, and performance patterns using real-world analytical SQL techniques.
